...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ["Notify", "LocalStorage", "Loading","LoadingBar","Cookies","AddressbarColor","AppFullscreen","Dialog","Dark"]
    },
    ...
    pwa: {
      ...
      manifest: {
        name: 'HDCApp',
        short_name: 'HDCApp',
        description: 'HDCApp Application MultiServices',
        display: 'standalone',
