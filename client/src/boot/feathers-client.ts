...
const apiUrl = window.location.origin;//"http://localhost:3030"//"https://svrdsiweb.agglo.local:3050";//"https://www.hdcapp.pro";//import.meta.env.VITE_APP1_API_URL as string
